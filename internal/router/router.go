...
func Routes() *mux.Router {
	...
	router.HandleFunc("/devices", handlers.BulkDeleteDevices).Methods("DELETE")
	...
	router.HandleFunc("/interfaces", handlers.BulkDeleteInterfaces).Methods("DELETE")
	...
	router.HandleFunc("/locations", handlers.BulkDeleteLocations).Methods("DELETE")
	...
	router.HandleFunc("/locations/{id}/devices", handlers.GetDevicesByLocation).Methods("GET")
	router.HandleFunc("/devices/{id}/interfaces", handlers.GetInterfacesByDevice).Methods("GET")
